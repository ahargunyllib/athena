...
fun PermissionBox(
    ...
    errorText = if (permissionState.revokedPermissions.none { it.permission in requiredPermissions }) {
        ""
    } else {
        "${permissionState.revokedPermissions.joinToString()} required for the sample"
    }
